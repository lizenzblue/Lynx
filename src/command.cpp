...
bool CommandExecutor::executeBuiltinCommand(const Command& cmd) {
    if (cmd.name == "cd") {
...
void CommandExecutor::executeExternalCommand(const Command& cmd) {
...
bool CommandExecutor::executeHistory() {
    // This is a placeholder - we need access to the shell's history
    // In a real implementation, we'd pass a reference to the shell
    std::cout << "History functionality requires shell context" << std::endl;
    return true;
}

bool CommandExecutor::executeEnv() {
    // This is a placeholder - we need access to the shell's environment
    // In a real implementation, we'd pass a reference to the shell
    extern char **environ;
